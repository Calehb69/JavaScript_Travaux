...
//index de la phrase la plus longue avec un démarrage à 0; 
let indexLonguestPhrase = 0;


/*********************************
 * BOUCLE
**********************************/
//La boucle parcours l'ensemble du tableau
for (let index = 0; index < phrases.lenght; index++) {
  /*
   ...
   */
  if (phrases[index].length > phrases[indexLonguestPhrase].length) {
    /*******************************************************************************************
     * Cas où la phrase courante est plus longue que celle qui était la plus longue jusqu'alors.
     * On sélectionne donc la phrase courante comme étant désormais celle étant la plus longue.
    ********************************************************************************************/
    indexLonguestPhrase = index;
  }
}
...
document.querySelector(
  "#content"
).innerHTML = `<p>La phrase la plus longue est : <i>${phrases[indexLonguestPhrase]}</i> et elle fait ${phrases[indexLonguestPhrase].length} caractère(s) !</p>`;
