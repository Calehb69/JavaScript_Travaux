...
function refreshTodoList() {
    ...
    // Suppression de l'ensemble de la liste de tâches HTML et ajout d'une UL vide

    let list = "<ul>";
    // Affichage HTML de la liste de tâches, une tâche à la fois.
...
function showDetails(element) {
     ...
     * cette balise contient un data-attribut contenant l'index dans le tableau de la tâche
     * on accède aux data attributs grâce à la propriété datatset
     */
    index = element.dataset.index;

    // Chargement de la liste de tâches puis récupération de la tâche sur laquelle on a cliqué.
